      ...
      <div className="fixed bottom-5 right-5 sm:bottom-6 sm:right-6 z-40 flex flex-col items-end gap-3 pointer-events-none">
        ...
        <div className="pointer-events-auto flex items-center group relative">
          <button
            ...
            className="relative w-13 h-13 sm:w-14 sm:h-14 rounded-full bg-[#9EAC99] hover:bg-[#a9b7a4] text-[#131210] flex items-center justify-center shadow-xl hover:shadow-[0_8px_25px_rgba(158,172,153,0.6)] transition-all duration-300 border border-white/40 cursor-pointer focus:outline-none focus:ring-2 focus:ring-[#9EAC99] focus:ring-offset-2 focus:ring-offset-[#131210]"
